...
*/
func (config *NodesConf) AddNode(nodeID string) (*Node, error) {
...
*/
func (config *NodesConf) DelNode(nodeID string) error {
	if _, ok := config.nodes[nodeID]; !ok {
...
*/
func (config *NodesConf) SetNode(nodeID string, vals Node) error {
...
*/
func (config *NodesConf) SetProfile(profileId string, vals Profile) error {
...
Add a node with the given ID and return a pointer to it
*/
func (config *NodesConf) AddProfile(profileId string) (*Profile, error) {
...
delete node with the given id
*/
func (config *NodesConf) DelProfile(nodeID string) error {
	if _, ok := config.nodes[nodeID]; !ok {
...
/*
Write the the NodesConf to disk.
*/
func (config *NodesConf) Persist() error {
...
*/
func (config *NodesConf) Dump() ([]byte, error) {
